...
(function () {
  ...
  angular.module('zAdmin.const')
	.constant('ENV_CONST', {
		...
		DEFAULT_CATEGORY_HOTKEYS:{'SocialRel': 'V', 'Agent': 'A', 'Characteristic': 'C', 'Stimulus': 'Z', 'Part/Portion': '/', 'Circumstance': 'Y', 'Whole': 'W', 'ComparisonRef': '=', 'Recipient': 'R', 'Identity': 'I', 'Explanation': 'E', 'Gestalt': 'K', 'Duration': 'U', 'Goal': 'G', 'Theme': 'H', 'Time': 'T', 'Co-Agent': '-', 'Quantity': 'Q', 'Experiencer': 'X', 'Originator': 'F', 'Beneficiary': 'B', 'Locus': 'L', 'Possessor': "'", 'Direction': 'D', 'Manner': 'M', 'Topic': 'O', 'OrgRole': 'J', 'Source': 'S', 'Approximator': '~', 'Purpose': 'P'}
